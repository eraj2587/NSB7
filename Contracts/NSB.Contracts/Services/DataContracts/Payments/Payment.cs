...
namespace NSB.Contracts.Services.DataContracts
{
    ...
    {
        [DataMember]
        public string NSBPublicId { get; set; }
        [DataMember]
        public string PaymentReference { get; set; }
        [DataMember]
        public string NSBPaymentStatus { get; set; }
        [DataMember]
        public string ItemType { get; set; }
        ...
        [DataMember]
        public string NSBBankName { get; set; }
    ...
    public class PaymentGeneralDetailsResponse
    {
        ...
        // As per Alex email: The NSB2 Payment ID can be changed to the Original Payment ID
        [DataMember]
        public string PublicId { get; set; }
        [DataMember]
