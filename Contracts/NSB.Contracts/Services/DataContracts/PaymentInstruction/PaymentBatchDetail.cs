...
namespace NSB.Contracts.Services.DataContracts
{
    ...
    public class PaymentBatchDetail
    {
        ...
        [DataMember]
        public int NSBBankAccountOwnerId { get; set; }
        [DataMember]
        [NameFormat]
        public string NSBBankAccountOwnerName { get; set; }
        [DataMember]
        public string NSBBankAccountOwnerShortName { get; set; }
        [DataMember]
	  	[PostalAddressFormat]
        public string NSBBankAccountAddressLine { get; set; }
        [DataMember]
        [PostalAddressFormat]
        public string NSBBankAccountCity { get; set; }
        [DataMember]
        [PostalAddressFormat]
        public string NSBBankAccountProvinceState { get; set; }
        [DataMember]
        [PostalAddressFormat]
        public string NSBBankAccountPostalCode { get; set; }
        [DataMember]
        [PostalAddressFormat]
        public string NSBBankAccountCountry { get; set; }
        [DataMember]
        [AccountNumberFormat]
        public string NSBBankAccountNumber { get; set; }
        [DataMember]
        [SwiftAddressFormat]
        public string NSBBankAccountReceiverBic { get; set; }
        [DataMember]
        [NameFormat]
