...
namespace ServiceModelEx
{
    public static class MetadataHelper
   {
      ...
      public static ServiceEndpoint[] GetEndpoints(string mexAddress)
      {
         ...
         {
             TcpTransportBindingElement netbindingElement = new TcpTransportBindingElement();
             netbindingElement.MaxReceivedMessageSize *= MessageSizeMultiplier;
             bindingElement = netbindingElement;
            }
         if(address.Scheme == Uri.UriSchemeNetPipe)
         {
             NamedPipeTransportBindingElement namebindingElement = new NamedPipeTransportBindingElement();
             namebindingElement.MaxReceivedMessageSize *= MessageSizeMultiplier;
             bindingElement = namebindingElement;
            }
